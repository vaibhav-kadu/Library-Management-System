...
export default function StudentDetails({ studentId, onClose, theme = "light" }) {
  ...
  useEffect(() => {
    const fetchStudentDetails = async () => {
      try {
        setLoading(true);
        const response = await axios.get(`http://localhost:3000/getStudentById/${studentId}`);
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {student.lid ? (
                      <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${
                        isDark ? 'bg-green-600/20 text-green-400' : 'bg-green-100 text-green-800'
                      }`}>
                      ...
                      <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${
                        isDark ? 'bg-red-600/20 text-red-400' : 'bg-red-100 text-red-800'
                      }`}>
